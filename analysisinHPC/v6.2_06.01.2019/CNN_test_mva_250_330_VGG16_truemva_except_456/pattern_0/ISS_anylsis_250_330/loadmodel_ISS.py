...
######################### Test events ##################################
testset1 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/ISS/147-1000GeV/transferdata/positive/250_330GeV/pattern0/positive_250_330_pattern_0.npy')
testset2 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/ISS/147-1000GeV/transferdata/negative/250_330GeV/pattern0/negative_250_330_pattern_0.npy')
if (EcalBDTCut):
