...
if cccut == True:
	TH_template_correct = TH2D("template_correct","Antiproton", CCbinningnumber,cccutvalue,1,TRDbinningnumber,0.1,1.5)
	TH_template_confused = TH2D("template_confused","Charge Confused Proton", CCbinningnumber,cccutvalue,1,TRDbinningnumber,0.1,1.5)
	TH_template_electron = TH2D("template_electron","Electron", CCbinningnumber,cccutvalue,1,TRDbinningnumber,0.1,1.5)
	TH_data_negative = TH2D("data_negative","Negative Rigidity Events", CCbinningnumber,cccutvalue,1,TRDbinningnumber,0.1,1.5)
	TH_data_positive = TH2D("data_positive","Positive Rigidity Events", CCbinningnumber,cccutvalue,1,TRDbinningnumber,0.1,1.5)
else:
