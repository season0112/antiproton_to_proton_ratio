...
positiveprotonB1042 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/147-1000GeV/transferdata/positive/211_250GeV/pattern0/positive_211_250_pattern_0.npy',encoding="latin1")
CCprotonB1042 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_pr.pl1.flux.l1a9.2016000_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy',encoding="latin1")
positiveprotonB1042 = positiveprotonB1042[0:CCprotonB1042.shape[0],:]
electronpositive = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1091_el.pl1.0_25200_7.6_all/147-1000GeV/transferdata/positive/211_250GeV/pattern0/positive_211_250_pattern_0.npy')
electronnegative = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1091_el.pl1.0_25200_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy')
...
if Testsample is "proton":
	testset1 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/147-1000GeV/transferdata/positive/211_250GeV/pattern0/positive_211_250_pattern_0.npy',encoding="latin1")
	testset2 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_pr.pl1.flux.l1o9.2016000_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy',encoding="latin1")
	testset2 = np.row_stack((testset2,np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_pr.pl1.flux.l1a9.2016000_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy',encoding="latin1")))
	...
	if (EcalBDTCut):
        ...
        testset1 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_antipr.pl1.1800_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy',encoding="latin1")
        testset2 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1042_antipr.pl1.1800_7.6_all/147-1000GeV/transferdata/positive/211_250GeV/pattern0/positive_211_250_pattern_0.npy',encoding="latin1")
        testset1 = testset1[-testset2.shape[0]:,:]
        if (EcalBDTCut):
                testset1 = testset1[np.where((testset1[:,-5]>-2) & (testset1[:,-5] < EcalBDTCutvalue_select_proton))[0],:]
                testset2 = testset2[np.where((testset2[:,-5]>-2) & (testset2[:,-5] < EcalBDTCutvalue_select_proton))[0],:]
        ...
        testset1 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1091_el.pl1.0_25200_7.6_all/147-1000GeV/transferdata/negative/211_250GeV/pattern0/negative_211_250_pattern_0.npy',encoding="latin1")
        testset2 = np.load('/hpcwork/jara0052/sichen/analysis_6.2/B1091_el.pl1.0_25200_7.6_all/147-1000GeV/transferdata/positive/211_250GeV/pattern0/positive_211_250_pattern_0.npy',encoding="latin1")
        testset1 = testset1[-testset2.shape[0]:,:]
        if (EcalBDTCut):
