...
##################### data ####################################################
template_correct=np.load('../../plot_ISS_positive_rigidity80.5_93.0.npy')
template_confused=np.load('../../plot_negative_rigidity80.5_93.0.npy')
template_electron=np.load('../../electron_negative80.5_93.0.npy')
data_negative=np.load('../../plot_ISS_negative_rigidity80.5_93.0.npy')
data_positive=np.load('../../plot_ISS_positive_rigidity80.5_93.0.npy')
'''
